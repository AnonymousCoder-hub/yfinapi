...
class handler(BaseHTTPRequestHandler):
    def do_GET(self):
        try:
            ...
            # Top Indian stocks to check for losers
            stocks_to_check = {
                'nse': [
            ...
            # Sort by change percentage (biggest losers first)
            losers_data.sort(key=lambda x: x['change_percent'])
            losers_data = losers_data[:limit]
